...
EndBasic:        
                        ...
                        display "Chunk of Array for Units : \t\t", /A, UnitsObjectArrayPtr, " = busy [ ", /D, UnitsObjectArraySize, " bytes ]"
                        display "Chunk of Array for Dynamic Objects : \t", /A, DynamicObjectArrayPtr, " = busy [ ", /D, DynamicObjectArraySize, " bytes ]"
