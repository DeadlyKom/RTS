                ...
                ifndef _CORE_MODULE_MENU_MAIN_NEW_GAME_ROOM_DRAW_FRAME_
                define _CORE_MODULE_MENU_MAIN_NEW_GAME_ROOM_DRAW_FRAME_
; -----------------------------------------
; отображение кадра
; In:
; Out:
...
DrawFrame:      ; расчёт адреса фрейма
                ...
                endif ; ~ _CORE_MODULE_MENU_MAIN_NEW_GAME_ROOM_DRAW_FRAME_
