                ...
                ifndef _CORE_MODULE_MENU_MAIN_NEW_GAME_ANIMATION_CORE_DRAW_
                define _CORE_MODULE_MENU_MAIN_NEW_GAME_ANIMATION_CORE_DRAW_
; -----------------------------------------
...
@Animation.Core.Draw:
                ...
                endif ; ~ _CORE_MODULE_MENU_MAIN_NEW_GAME_ANIMATION_CORE_DRAW_
