                ...
                ifndef _CORE_MODULE_CAPTAIN_BRIDGE_ANIMATION_LEFT_TICK_
                define _CORE_MODULE_CAPTAIN_BRIDGE_ANIMATION_LEFT_TICK_
...
.Animate        ; обратный отсчёт продолжительности 
                ...
                endif ; ~ _CORE_MODULE_CAPTAIN_BRIDGE_ANIMATION_LEFT_TICK_
