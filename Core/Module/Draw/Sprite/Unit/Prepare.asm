...
.ClipLeft       ; ---------------------------------------------
                ...
                ; ---------------------------------------------
                ; HL  - хранит положение спрайта (правой части спрайта), относительно левой границы видимой области
                ; DE  - 16-битное значение ширины спрайта
                ...
                ; LD B, H                                                         ; сохранение новой ширины спрайта
                JR .AdjustScrAdr
...
.AdjustScrAdr   ; ---------------------------------------------
                ; H   - позиция спрайта по горизонтали в пикселях
                ; L   - ширина невидимой части спрайта в пикселях
                ; BC  - размер спрайта (B - изначальная ширина, C - изначальная/изменённая высота) в пикселях
                ; ---------------------------------------------
...
.Shift_OR       DW #0000, #0000, #0000, #0000, #0000
.Shift_OR_XOR   DW Table.Shift.OX_8,    Table.Shift.OX_16,      Table.Shift.OX_24,      Table.Shift.OX_32,      Table.Shift.OX_40
