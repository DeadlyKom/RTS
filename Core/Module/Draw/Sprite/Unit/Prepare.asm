...
.BelowTop       ; ---------------------------------------------
                ...
                LD H, A
                LD A, L                                                         ; сохранение положение спрайта, относительно верхней границы видимой области (в пикселях)
                ADD HL, DE
                JR NC, .ScrAdrRow                                               ; переход, если при добавлении размера спрайта по вертикали,
                                                                                ; не произошло переполнене. значение отрицательное
                                                                                ; спрайт виден полностью
.ClipBottom     ; ---------------------------------------------
...
.ToRightOfEdge  ; ---------------------------------------------
                ...
                LD H, A
                LD A, L                                                         ; сохранение положение спрайта, относительно левой границы видимой области (в пикселях)
                ADD HL, DE
