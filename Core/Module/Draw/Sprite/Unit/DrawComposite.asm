...
; Corrupt:
; Note:
;   для данного вида "составного" спрайта, тебуется:
;    - чтобы спрайты были кратные 16, т.к. для анимируемых тайлов,
;      необходимо расчитывать адреса фреймов, без чёткого размера спрайта сделать нельзя
; -----------------------------------------
DrawComposite:  EXX
