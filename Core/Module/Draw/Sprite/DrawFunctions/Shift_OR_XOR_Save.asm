                ...
                ifndef _CORE_MODULE_DRAW_SPRITE_DRAW_FUNCTION_SHIFT_OR_XOR_SAVE_
                define _CORE_MODULE_DRAW_SPRITE_DRAW_FUNCTION_SHIFT_OR_XOR_SAVE_
...
;                 DW Shift_OX_Right._x_XXXx,  Shift_OX_Right._x_XXXx_             ; +3.5 байт
                ...
                display " - Draw Function 'Shift OR & XOR - Save' : \t\t", /A, Begin_Shift, " = busy [ ", /D, $ - Begin_Shift, " bytes  ]"

                endmodule

                endif ; ~ _CORE_MODULE_DRAW_SPRITE_DRAW_FUNCTION_SHIFT_OR_XOR_SAVE_
